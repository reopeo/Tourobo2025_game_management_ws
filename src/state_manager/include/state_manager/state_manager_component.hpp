...
namespace torobo2024
{
    ...
    private:
        ...
        bool _match_already_set(game_state_interfaces::msg::Match &m)
        {
            return current_match_.id == m.id;
        }

        bool _is_match_ready()
        {
            return !is_match_start_ && !is_match_confirmed_;
        }

        bool _is_match_running()
        {
            return is_match_start_ && !is_match_end_;
        }
        ...
        bool _is_match_confirmed()
        {
            return is_match_confirmed_;
        }
    ...
    public:
        ...
        StateManager(const std::string &name_space = "", const rclcpp::NodeOptions &options = rclcpp::NodeOptions()) : Node("state_manager_node", name_space, options)
        {
            ...
            load_next_map_srv_ = this->create_service<std_srvs::srv::Empty>("/match/load_next", std::bind(&StateManager::load_next_match, this, std::placeholders::_1, std::placeholders::_2));
            ...
            end_match_srv_ = this->create_service<game_state_interfaces::srv::EndMatch>("/match/end", std::bind(&StateManager::end_match, this, std::placeholders::_1, std::placeholders::_2));
            ...
            red_update_score_srv_ = this->create_service<game_state_interfaces::srv::UpdateScore>("/red/update_score", std::bind(&StateManager::red_update_score, this, std::placeholders::_1, std::placeholders::_2));
            blue_update_score_srv_ = this->create_service<game_state_interfaces::srv::UpdateScore>("/blue/update_score", std::bind(&StateManager::blue_update_score, this, std::placeholders::_1, std::placeholders::_2));
        ...
        void reset_match(const std_srvs::srv::Empty::Request::SharedPtr, const std_srvs::srv::Empty::Response::SharedPtr)
        {
            init_match();
        }
